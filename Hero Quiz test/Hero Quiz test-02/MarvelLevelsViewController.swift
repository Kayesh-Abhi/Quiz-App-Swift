//
//  MarvelLevelsViewController.swift
//  Hero Quiz test-02
//
//  Created by kayesh Abhisheka on 2021-09-01.
//

import UIKit

class MarvelLevelsViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let RQV = segue.destination as! ViewController
